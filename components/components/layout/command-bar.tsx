...
const ACTIONS: CommandAction[] = [
  ...
  { id: "nav-dunning-ladder", label: "Statutory ladder", hint: "Go", href: "/receivables/ladder", keywords: "rera dunning chase demand notice reminder final cancellation warning allottee" },
