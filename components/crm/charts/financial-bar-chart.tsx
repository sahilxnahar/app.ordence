      ...
      <dl className="mt-1.5 space-y-1">
        <div className="flex items-center justify-between gap-6 text-xs">
          ...
          <dd className="font-medium tabular-nums text-foreground">
            {formatCurrencyString(row.debitsExact)}
          </dd>
        </div>
        ...
        <div className="flex items-center justify-between gap-6 text-xs">
          ...
          <dd className="font-medium tabular-nums text-foreground">
            {formatCurrencyString(row.creditsExact)}
          </dd>
        </div>
      </dl>
      ...
      <dl className="grid grid-cols-2 gap-3 sm:grid-cols-3">
        <div className="rounded-md border border-border p-3">
          ...
          <dd className="mt-1 text-lg font-semibold tabular-nums">
            {formatCurrencyString(totalDebits)}
          </dd>
        </div>
        ...
        <div className="rounded-md border border-border p-3">
          ...
          <dd className="mt-1 text-lg font-semibold tabular-nums">
            {formatCurrencyString(totalCredits)}
          </dd>
        </div>
        ...
        */}
        <div className="col-span-2 rounded-md border border-border p-3 sm:col-span-1">
          ...
          >
            {isBalanced ? "Balanced" : `Out by ${formatCurrencyString(difference)}`}
          </dd>
        </div>
      </dl>
